...
$(document).ready(function () {
    function d() {
        ...
        setTimeout(function () {
            $(".slide.active img.fade,.slide.active .info,.slide.active .p-view").fadeIn(1600, "easeInOutQuad", function () {
    ...
    function c() {
        ...
        function j() {
            ...
            setTimeout(function () {
                $(".slide.active img.fade,.slide.active .info").fadeIn(1600, "easeInOutQuad", function () {
                    $("#feature_slider").removeClass()
                })
            }, 1600)
        }
        function g() {
            ...
            $(".slide.previous img.fade,.slide.previous .info,.slide.active .p-view").fadeOut(1600, "easeInQuad", function () {
                $(".slide.next").removeClass("next").addClass("active").fadeIn(1500, "easeInOutQuad", function () {
                    $(".slide.previous").removeClass("previous").fadeOut(1500, "easeInOutQuad");
                    j()
                })
            })
        }
        $(".slide:first").addClass("active").fadeIn(1500, "easeInOutQuad", function () {
            $("#slide-left, #slide-right, #pagination").fadeIn(1200, "easeInOutQuad", function () {
                j()
            })
        });
